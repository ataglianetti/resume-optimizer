...
When the user asks you to optimize their resume for a job, follow these instructions carefully.
...
3. **Generate markdown resume**:
   - Save to `../../../../Calendar/YYYY-MM-DD_[Company]_[Role]_Resume.md` (use today's date)
...
4. **Generate HTML version**:
   ...
   - Save to `../../../../Calendar/YYYY-MM-DD_[Company]_[Role]_Resume.html` (use today's date)
...
5. **Generate essay responses (if questions were found)**:
   ...
   - Save to `../../../../Calendar/YYYY-MM-DD_[Company]_[Role]_Essay_Responses.md`
   - Format as:
     ```markdown
...
6. **Log to daily note**:
   - Daily note path: `../../../../Calendar/YYYY-MM-DD.md` (use today's date in YYYY-MM-DD format)
   - If today's daily note doesn't exist, create it
   - Find the "## Log" heading in the daily note (or create it if it doesn't exist)
   - Add a bullet point UNDER the Log heading with this format:
     ```
     - Applied to [Job Title at Company](job-listing-url). [[YYYY-MM-DD_Company_Role_Resume.md|md]] | [[YYYY-MM-DD_Company_Role_Resume.html|html]]
     ```
   - Use the actual job URL provided by the user
   - Include both .md and .html file extensions in the wikilinks to provide quick access to both formats
   - If a cover letter was generated, add it after the resume links: `| [[YYYY-MM-DD_Company_Role_Cover_Letter.md|Cover Letter]]`
   - **If essay responses were generated**, add: `| [[YYYY-MM-DD_Company_Role_Essay_Responses.md|Essay Responses]]`
   - Example: `- Applied to [Senior Product Manager, AI at CompanyCam](https://companycam.com/job?gh_jid=123). [[2025-10-19_CompanyCam_Senior_Product_Manager_AI_Resume.md|md]] | [[2025-10-19_CompanyCam_Senior_Product_Manager_AI_Resume.html|html]] | [[2025-10-19_CompanyCam_Senior_Product_Manager_AI_Essay_Responses.md|Essay Responses]]`
